                ...
                <div class="widget products-widget">
                    ...
                    <div class="widget-body">
                        <form class="forms-sample" method="post"
                            action="<?php echo base_url("contact_settings/update/$item->id"); ?>"
                            enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Firma Ünvanı</label>
                                <input type="text" class="form-control" name="firma_adi"
                                    value="<?php echo $item->firma_adi; ?>" placeholder="Firma Adı">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="firma_fax"
                                    value="<?php echo $item->firma_fax; ?>" placeholder="Firma Fax">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="firma_adres"
                                    value="<?php echo $item->firma_adres; ?>" placeholder="Firma Adres">
                            </div>
