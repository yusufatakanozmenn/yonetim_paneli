                            ...
                            <form action="<?php echo base_url("product/save"); ?>" method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control form-control-sm" name="sira"
                                                id="sira" value="">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Fiyat</label>
                                            <input type="text" class="form-control form-control-sm" name="fiyat"
                                                value="">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="ifiyat"
                                                value="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="" id="urun-bilgileri" role="tabpanel" aria-labelledby="home-tab-vertical">
                                    <form action="<?php echo base_url("product/save"); ?>" method="post">
                                        <div class="form-group">
                                            <label for="adi">Başlık</label>
                                            <input type="text" class="form-control form-control-sm" min="0" name="adi"
                                                id="adi" value="">
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="secenek">Kategori</label>
                                            <select
                                                class="js-example-basic-multiple form-control-sm select2-hidden-accessible"
                                                name="kategori" id="secenek" required="" style="width:100%"
                                                ...
                                                dir="ltr" style="width: 100%;"><span class="selection"><span
                                                        ...
                                                        tabindex="0" aria-labelledby="select2-secenek-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-secenek-container"
                                                            title="Ürünler">Ürünler</span><span
                                        ...
                                        <div class="form-group">
                                            <label for="spot">Spot Metin <i class="icon-info text-info"
                                                    data-toggle="popover"
                                        ...
                                        <div class="" id="urun-ozellikleri" role="tabpanel"
