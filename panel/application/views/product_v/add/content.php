    ...
    <div class="" id="urun-bilgileri" role="tabpanel" aria-labelledby="home-tab-vertical">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm" placeholder="Ürün Kodu" name="urun_kodu"
                    id="urun_kodu" value="">
            </div>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm" placeholder="İndirimli Fiyat" name="ifiyat"
                    value="">
            </div>
        </div>
        <div class="form-group">
