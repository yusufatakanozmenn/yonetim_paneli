                ...
                <div class="row mb-3">
                    <div class="col-lg-12">
                        <div class="btn-toolbar" role="toolbar">
                            <a href="hizmet-ekle" class="btn btn-primary btn-sm mr-1">
                                <i class="icon-plus font-12"></i> Yeni Ürün Ekle </a>
                            <div class="dropdown mr-1">
                                ...
                                <div class="dropdown-menu p-0 min-width-full" aria-labelledby="dropdownMenuSizeButton3">
                                    <button class="dropdown-item p-2 cursor-pointer" type="submit"
                                        name="hizmet_aktif"><i class="icon-check"></i> Seçilenleri Aktif Et</button>
                                    <button class="dropdown-item p-2 cursor-pointer" type="submit"
                                        name="hizmet_pasif"><i class="icon-close"></i> Seçilenleri Pasif Et</button>
                                    <button class="dropdown-item p-2 cursor-pointer" type="submit" name="hizmet_tumu"><i
                                            class="icon-trash"></i> Seçilenleri Sil</button>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="dataTables_length" id="order-listingg_length"><label>Sayfada
                                                <select name="order-listingg_length" aria-controls="order-listingg"
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div id="order-listingg_filter" class="dataTables_filter"><label>Ara:<input
                                                    type="search" class="form-control form-control-sm" placeholder=""
                                                    aria-controls="order-listingg"></label></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="order-listingg"
                                            ...
                                            aria-describedby="order-listingg_info" style="width: 1308px;">
                                            <thead class="headbg">
                                                <tr role="row">
                                                    <th class="noshort sorting_disabled" style="width: 38.8px;"
                                                        data-toggle="tooltip" data-placement="top" title="Tümünü Seç"
                                                    ...
                                                    <th class="secili sorting" tabindex="0"
                                                        ...
                                                        Başlık</th>
                                                    <th style="width: 69.8px;" class="secili text-center sorting"
