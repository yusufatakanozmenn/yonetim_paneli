...
<div class="card-body">
    <form class="forms-sample" method="post" action="<?php echo base_url("language_list/update/$item->id");?>" enctype="multipart/form-data">
        <div class="form-group">
            <label for="sira">Sıra</label>
            <input type="text" class="form-control form-control-sm" name="sira" id="sira" value="<?php echo $item->sira ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select class="icons_select2 select2-hidden-accessible" name="bayrak" style="width:100%" tabindex="-1" aria-hidden="true">
                ...
                <option value="<?php echo $item->bayrak ?>" selected>Selected Flag</option>
        ...
        <a href="<?php echo base_url("language_list/update"); ?>"></a>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="editable-form"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    <th style="width:250px;" class="sorting_asc" tabindex="0"
                                                        aria-controls="editable-form" rowspan="1" colspan="1"
                                                        aria-sort="ascending"
                                                        aria-label="Key: azalan sütun soralamasını aktifleştir">Key</th>
                                                    <th class="sorting" tabindex="0" aria-controls="editable-form"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Açıklama: artan sütun sıralamasını aktifleştir"
                                                        style="width: 1148.95px;">Açıklama</th>
                                                </tr>
                                            </thead>
                                            <?php if(file_exists($BASEPATH . "languages/dil_$item->id.php")){ ?>
                                                <?php include($BASEPATH . "languages/dil_$item->id.php"); ?>
                                                <?php
                                                foreach ($dil as $key => $val) { ?>
                                                <tbody>
                                                ...
                                                <td><input class="language_value"
                                                        type="text"
                                                        name="<?php echo $key;?>"
                                                        data-url="<?php echo base_url("language_list/update_language_text/$item->id");?>"
                                                        id="<?php echo $key;?>"
                                                        value="<?php echo $val;?>"
                                                ></td>
                                                </tr>
