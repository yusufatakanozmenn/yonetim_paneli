        ...
        <h4>
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-12">
                                <div class="btn-toolbar" role="toolbar">
                                    <a href="<?php echo base_url("bank_account/add_form"); ?>"
            ...
            <div class="alert alert-info text-center">
                <p>Burada herhangi bir veri bulunmamaktadır. Eklemek için lütfen <a
                        href="<?php echo base_url("bank_account/new_form"); ?>">tıklayınız</a></p>
            </div>
            <?php } else { ?>
                                                <table id="order-listingg"
                                                    ...
                                                    <tbody id="sortable" class="ui-sortable">
                                                        ...
                                                        <tr id="item-8" role="row" class="odd">
                                                            ...
                                                            <td class=" secili"><?php echo $item->banka;?></td>
                                                            <td class=" secili"><?php echo $item->hesap;?></td>
                                                            <td class=" secili"><?php echo $item->durum;?></td>                                                               
                                                            <td>
                                                                <a href="<?php echo base_url("bank_account/delete/$item->id");?>"><i class="fa fa-trash"></i>
                                                                </a>
                                                                <a href="<?php echo base_url("bank_account/delete/$item->id");?>" class="btn btn-sm btn-info btn-outline"><i
