                                        ...
                                        <div class="dropdown mr-1">
                                            ...
                                            <div class="dropdown-menu p-0 min-width-full"
                                                ...
                                                <button class="dropdown-item p-2 cursor-pointer" type="submit"
                                                    name="proje_aktif"><i class="icon-check"></i> Seçilenleri Aktif
                                                    Et</button>
                                                <button class="dropdown-item p-2 cursor-pointer" type="submit"
                                                    name="proje_pasif"><i class="icon-close"></i> Seçilenleri Pasif
                                                    Et</button>
                                                <button class="dropdown-item p-2 cursor-pointer" type="submit"
                                                    name="proje_tumu"><i class="icon-trash"></i> Seçilenleri
                                                    Sil</button>
                                            </div>
                                        </div>
                                        <a href="../_class/yonetim_islem.php?projetumunusil=ok" title=""
                                                        ...
                                                        <thead class="headbg">
                                                            <tr role="row">
                                                                ...
                                                                <th class="secili sorting" tabindex="0"
                                                                    ...
                                                                    colspan="1" style="width: 363.8px;"
                                                                    aria-label="Başlık: artan sütun sıralamasını aktifleştir">
                                                                    Başlık</th>
                                                                <th class="secili sorting" tabindex="0"
                                                                    aria-controls="order-listingg" rowspan="1"
                                                                    colspan="1" style="width: 441.8px;"
