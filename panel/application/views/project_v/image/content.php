    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("project/image_upload/$item->id"); ?>" id="dropzone" class="dropzone" data-plugin="dropzone" data-options="{ url: '<?php echo base_url("project/image_upload/$item->id"); ?>'}">
                    ...
                    <table class="table table-bordered table-striped table-hover pictures_list">
                        ...
                        <?php foreach($item_images as $image){ ?>
                            ...
                            <tr>
                                ...
                                <td class="w100 text-center">
                                    <a
                                        href="<?php echo base_url("project/image_delete/$item->id/$image->resim"); ?>"
