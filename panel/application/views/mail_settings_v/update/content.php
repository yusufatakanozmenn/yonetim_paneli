            ...
            <div class="card-body">
                <form class="forms-sample" method="post" action="../_class/yonetim_islem.php"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="m_port" id="m_port" value="<?php echo $item->m_port;?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <label class="switch">
                            <input type="checkbox" name="durum" id="durum" value="<?php echo $item->durum;?>" checked="">
