                    ...
                    <div class="main-panel">
                        <div class="row">
                            <div class="col-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <form class="forms-sample" method="post" action="<?php echo base_url("panel/general_settings/update");?>
                                                            ...
                                                            <div class="input-group col-xs-12">
                                                                <div class="col-md-6 col-sm-6">
                                                                    <a href="#" class="thumbnail white">
                                                                        <img src="<?php echo base_url("assets");?>assets"<?php $item->firma_logo;?>"
                                                                        alt="...">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group col-xs-12">
                                                                <div class="col-md-6 col-sm-6">
                                                                    <a href="#" class="thumbnail white">
                                                                        <img src="<?php echo base_url("assets");?>assets"<?php $item->firma_footerlogo;?>"
                                                                        alt="...">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group col-xs-12">
                                                                <div class="col-md-6 col-sm-6">
                                                                    <a href="#" class="thumbnail white">
                                                                        <img src="<?php echo base_url("assets");?>assets"<?php $item->favicon;?>"                                                                                alt="...">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                   name="site_baslik" id="site_baslik" value="">
                                        </div>
                                        <div class="form-group">
