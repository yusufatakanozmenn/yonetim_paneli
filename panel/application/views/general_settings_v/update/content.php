                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="../_class/yonetim_islem.php"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" name="site_title" id="site_title"
                                value="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="video">Firma Tanıtım Video Url Linki <small></small></label><small>
                                <input type="text" class="form-control form-control-sm" name="video" id="video"
                                    value="">
                            </small>
                        </div><small>
                            <div class="form-group">
                                <label for="site_url"><b>Yönetim Paneli Girişi Link Adresi (Örnek: xyonetim, ypanel,
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="copyright" id="copyright"
                                    value="">
                            </div>
