                    ...
                    <div class="widget-body">
                        <form class="forms-sample" method="post"
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <input type="file" name="firma_logo" class="file-upload-default">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="site_baslik"
                                    id="site_baslik" value="<?php echo $item->site_baslik ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <small>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="maxlength-textarea" name="site_desc" class="form-control"
                                        maxlength="260" rows="4"><?php echo $item->site_desc ?></textarea>
                                </div>
                                <div class="form-group">
