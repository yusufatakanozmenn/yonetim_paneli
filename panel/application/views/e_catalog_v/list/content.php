                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="alert alert-info text-center">
                                                    <p>Burada herhangi bir veri bulunmamaktadır. Eklemek için lütfen <a
                                                            href="<?php echo base_url("e_catalog/new_form"); ?>">tıklayınız</a>
                                                    </p>
                                                </div>
                                                <?php } else { ?>
                                                <table id="order-listingg"
                                                    ...
                                                    <tbody id="sortable" class="ui-sortable">
                                                        ...
                                                        <tr id="item-13" role="row" class="odd">
                                                            ...
                                                            <td class=" secili text-center" ><div class="badge badge-outline-danger">
                                                            <?php    
                                                            if ( $item->durum == 1) {
                                                                echo "Aktif";
                                                                } else {
                                                            ...
                                                            <td>
                                                                <a href="<?php echo base_url("e_catalog/update/$item->id");?>"
                                                                    class="btn btn-sm btn-info btn-outline"><i
                                                                        class="fa fa-pencil-square-o"></i>
                                                                </a>
                                                                <a href="<?php echo base_url("e_catalog/delete/$item->id");?>"
