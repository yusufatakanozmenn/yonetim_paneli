                        ...
                        <div class="card">
                            <form action="../_class/yonetim_islem.php" method="POST">
								...
								">
                                                                        ...
                                                                        <th style="width: 29.8px;"
                                                                            class="secili sorting" tabindex="0"
                                                                        ...
                                                                        <th style="width: 69.8px;"
                                                                            class="text-center secili sorting"
                                                                        ...
                                                                        <th style="width: 89.6px;"
                                                                            ...
                                                                            rowspan="1" colspan="1" aria-label="İşlem">
                                                                            İşlem</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-5">
                                                            <div class="dataTables_info" id="order-listingg_info"
                                                                role="status" aria-live="polite">1 kayıttan 1 - 1
                                                            ...
                                                            <div class="dataTables_paginate paging_simple_numbers"
                                                                ...
                                                                <ul class="pagination">
                                                                    ...
                                                                    <li class="paginate_button page-item active"><a
                                                                            href="#" aria-controls="order-listingg"
