                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <div class="btn-toolbar" role="toolbar">
                                        <a href="proje-kategori-ekle" class="btn btn-primary btn-sm mr-1">
                                            <i class="icon-plus font-12"></i> Yeni Proje Kategori Ekle </a>
                                        <div class="dropdown mr-1">
                                            ...
                                            <div class="dropdown-menu p-0 min-width-full"
                                                ...
                                                <button class="dropdown-item p-2 cursor-pointer" type="submit"
                                                    name="proje_kat_aktif"><i class="icon-check"></i> Seçilenleri Aktif
                                                    Et</button>
                                                <button class="dropdown-item p-2 cursor-pointer" type="submit"
                                                    name="proje_kat_pasif"><i class="icon-close"></i> Seçilenleri Pasif
                                                    Et</button>
                                                <button class="dropdown-item p-2 cursor-pointer" type="submit"
                                                    name="proje_kat_tumu"><i class="icon-trash"></i> Seçilenleri
                                                    Sil</button>
                                            </div>
                                        </div>
                                        <a href="../_class/yonetim_islem.php?projekattumunusil=ok" title=""
                            ...
                            <div class="row">
								...
								">
                                                                ...
                                                                <th class="secili sorting" tabindex="0"
                                                                    ...
                                                                    colspan="1" style="width: 289.8px;"
                                                                    aria-label="Başlık: artan sütun sıralamasını aktifleştir">
                                                                    Başlık</th>
                                                                <th class="secili sorting" tabindex="0"
                                                                    aria-controls="order-listingg" rowspan="1"
                                                                    colspan="1" style="width: 314.8px;"
                                                                    aria-label="SEF Url: artan sütun sıralamasını aktifleştir">
                                                                    SEF Url</th>
