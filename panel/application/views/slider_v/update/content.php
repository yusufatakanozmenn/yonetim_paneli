    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-body">
                <form class="forms-sample" method="post" action="<?php echo base_url("slider/update/$item->id"); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="url" id="url" value="<?=$item->url?>">
                    </div>
                    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm" name="video" id="video" value="<?=$item->video?>">
            </div>
