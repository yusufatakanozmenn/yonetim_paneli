                        ...
                        <form class="forms-sample" method="post" action="">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="widget stats-widget">
                                        <div class="widget-body clearfix">
                                            <div class="pull-left" >
                                                <h3  class="widget-title text-primary"><span name="dfsadfasdf" class="counter"
                                        ...
                                        <div class="widget-body clearfix">
                                            <div class="pull-left">
                                                <h3 class="widget-title text-success"><span class="counter"
                                                        data-plugin="counterUp">21</span>Kisi</h3>
                                                <small class="text-color">Dün</small>
                                            </div>
                                            <span class="pull-right big-icon watermark"><i
                                        ...
                                        <div class="widget-body clearfix">
                                            <div class="pull-left">
                                                <h3 class="widget-title text-warning"><span class="counter"
                                                        data-plugin="counterUp">577</span>Kişi</h3>
                                                <small class="text-color">Bu Ay</small>
                                            </div>
                                            <span class="pull-right big-icon watermark"><i
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="widget">
                                        <header class="widget-header">
                                            <h4 class="card-title anatitle">BUGÜN SON İŞLEMLER <a
                                                    style="margin-top: -5px;"
                                                    class="float-right text-white popconfirm badge badge-danger"
                                                    title="" href="../_class/yonetim_islem.php?bildirimtumunusil=ok"
                                                    data-original-title="Tüm Bildirimi Sil">Tümünü Sil</a></h4>
                                ...
                                <div class="col-md-5">
                                    <div class="widget todo-widget">
                                        <header class="widget-header">
                                            <h4 class="widget-title">YAKLAŞAN İŞLER</h4>
                                            <div class="scroll mCustomScrollbar _mCS_1">
                                                <div id="mCSB_1"
                                                    class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside"
                                                    style="max-height: none;" tabindex="0">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="widget">
                                        <header class="widget-header">
                                            <h4 class="widget-title">GÜNCELLEMELER</h4>
                                        </header>
                                        <hr class="widget-separator" />
