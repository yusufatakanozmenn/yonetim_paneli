        ...
        <div class="col-md-7">
            <div class="widget">
                <header class="widget-header">
                    <h4 class="card-title anatitle">BUGÜN SON İŞLEMLER <a style="margin-top: -5px;"
                            class="float-right text-white popconfirm badge badge-danger" title=""
                            href="../_class/yonetim_islem.php?bildirimtumunusil=ok"
