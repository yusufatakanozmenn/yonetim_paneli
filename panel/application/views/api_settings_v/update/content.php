...
<div class="main-panel">
    ...
    <div class="form-group m-b-0">
        ...
        <textarea id="maxlength-demo-4" name="google_analytics" maxlength="200" class="form-control" 
    ...
    <div class="form-group m-b-0">
        ...
        <textarea id="maxlength-demo-4" name="dogrulama_kodu" maxlength="200" class="form-control" 
    ...
    <div class="form-group m-b-0">
        ...
        <textarea id="maxlength-demo-4" name="google_maps" maxlength="200" class="form-control" 
    ...
    <div class="form-group m-b-0">
        ...
        <textarea id="maxlength-demo-4" name="canli_destek" maxlength="200" class="form-control" 
